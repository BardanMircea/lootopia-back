...
public class DataSeeder {
    ...
    CommandLineRunner seedDatabase(
        ...
        return args -> {
            ...
            Participation p1 = new Participation(null, false, 1, false, null,null, mircea, chasse1,null, LocalDateTime.now().minusDays(1), Participation.Statut.ACTIF);
            Participation p2 = new Participation(null, true, -1, false, null, null, vlad, chasse2, null,LocalDateTime.now().minusDays(2), Participation.Statut.ACTIF);
